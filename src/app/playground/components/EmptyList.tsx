...
const EmptyList: EmptyListProps = ({ title, description }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-5">
      <EmptyIllustration />
      {title && (
        <h1 className="text-[12px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-bold z-10 mt-4">
          {title}
        </h1>
      )}
      {description && (
        <h1 className="text-[8px] sm:text-[12px] md:text-[16px] lg:text-[18px] font-bold z-10 mt-1">
          {description}
        </h1>
      )}
    </div>
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#2f2e41"
      />
      <circle cx="361.7217" cy="403.5046" r="62.98931" fill="#000000" />
      <path
