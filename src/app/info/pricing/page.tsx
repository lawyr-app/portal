          ...
          {plans.map((plan, index) => (
            ...
            >
              <div className="p-8">
                ...
                <ul className="mb-8 space-y-4">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start">
                      <Check className="w-5 h-5 mr-3 text-green-500 mt-1 flex-shrink-0" />
                ...
                <Button className="w-full text-lg py-3 bg-black text-white dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors duration-300">
                  {plan.cta}
                </Button>
              </div>
            </div>
