...
import { IconCloud, IconCurrencyDollar } from "@tabler/icons-react";
...
export default function Features() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  relative z-10 py-10 max-w-7xl mx-auto dark:bg-black">
